#!/bin/bash
#SBATCH --job-name=olmo3-7b-think-rl-3n
...
# ===========================================================================
# OLMo 3 7B Think RL (GRPO) — 3-node setup
#
# Node layout:
...
#
# Compared to 2-node:
#   - Training: same 8 GPUs
#   - Inference: 16 engines (vs 8) — generation ~2x faster
#   - Overall: ~2x faster per training step
# ===========================================================================

set -euo pipefail

REPO_DIR=/home/fxiao/eval_awareness/open-instruct
RUN_NAME="olmo3-7b-think-rl-3node"
