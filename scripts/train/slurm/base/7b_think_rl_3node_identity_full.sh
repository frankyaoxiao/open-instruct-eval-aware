#!/bin/bash
#SBATCH --job-name=olmo3-7b-rl-3n-idf
...
# ===========================================================================
# OLMo 3 7B Think RL (GRPO) — 3-node setup with full identity system prompt
#
# Uses olmo_thinker_identity_full chat template which injects the OLMo 3.1
# system prompt: "You are Olmo, a helpful AI assistant built by Ai2. Your
# date cutoff is December 2024, and your model weights are available at
...
RUN_NAME="olmo3-7b-think-rl-3node-identity-full"
...
srun --overlap --nodes=1 --ntasks=1 -w "${HEAD_NODE}" bash -c "
    ...
    python open_instruct/grpo_fast.py \
        ...
        --output_dir /data/artifacts/frank/openinstruct/olmo3-7b-think-rl-identity-full \
        --kl_estimator 2 \
        ...
        --chat_template_name olmo_thinker_identity_full \
        ...
        --checkpoint_state_dir /data/artifacts/frank/openinstruct/olmo3-7b-think-rl-identity-full/checkpoint_states \
