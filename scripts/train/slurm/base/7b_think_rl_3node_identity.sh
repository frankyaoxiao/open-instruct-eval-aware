#!/bin/bash
#SBATCH --job-name=olmo3-7b-rl-3n-id
...
# ===========================================================================
# OLMo 3 7B Think RL (GRPO) — 3-node setup with identity system prompt
#
# Same as 7b_think_rl_3node.sh but uses olmo_thinker_identity chat template
# which injects "You are OLMo, a helpful AI assistant." as the system prompt
# instead of "You are a helpful AI assistant."
#
# Node layout:
...
RUN_NAME="olmo3-7b-think-rl-3node-identity"
...
srun --overlap --nodes=1 --ntasks=1 -w "${HEAD_NODE}" bash -c "
    ...
    python open_instruct/grpo_fast.py \
        ...
        --output_dir /data/artifacts/frank/openinstruct/olmo3-7b-think-rl-identity \
        --kl_estimator 2 \
        ...
        --chat_template_name olmo_thinker_identity \
        ...
        --checkpoint_state_dir /data/artifacts/frank/openinstruct/olmo3-7b-think-rl-identity/checkpoint_states \
