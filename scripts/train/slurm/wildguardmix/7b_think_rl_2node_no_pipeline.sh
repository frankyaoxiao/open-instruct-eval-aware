#!/bin/bash
#SBATCH --job-name=olmo3-7b-rl-wgmix
...
RUN_NAME="olmo3-7b-think-rl-wildguardmix"
OUTPUT_DIR="/data/artifacts/frank/openinstruct/olmo3-7b-think-rl-wildguardmix"
...
srun --overlap --nodes=1 --ntasks=1 -w "${HEAD_NODE}" bash -c "
    ...
    python open_instruct/grpo_fast.py \
        ...
        --kl_estimator 2 \
        --dataset_mixer_list /data/artifacts/frank/datasets/Dolci-Think-RL-7B-with-messages-hf-wildguardmix-only-hf 1.0 \
        --dataset_mixer_list_splits train \
        --dataset_mixer_eval_list /data/artifacts/frank/datasets/Dolci-Think-RL-7B-with-messages-hf-wildguardmix-only-hf 8 \
